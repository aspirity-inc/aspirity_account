...
(function ($) {
    class $aspirity_account_transport extends $mol_object2 {
        static api_base() {
            return 'https://corssroc.herokuapp.com/https://helpmate.int.aspirity.com/_next/data/CyYy66KHAhtQN5bEooLAa/';
        }
        static token(next) {
...
(function ($) {
    ...
    __decorate([
        $mol_mem_key
    ], $aspirity_account_invoice_list.prototype, "load_full", null);
    __decorate([
        $mol_mem
...
(function ($) {
    class $aspirity_account_invoice_page extends $mol_page {
        ...
        title() {
            return this.$.$mol_locale.text('$aspirity_account_invoice_page_title');
        }
        statuses() {
            return {
                draft: "Draft"
        ...
        Address_ref() {
            const obj = new this.$.$mol_labeler();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_invoice_page_Address_ref_title');
            obj.content = () => [
                this.address_reg()
            ];
            return obj;
    ...
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Address_ref", null);
    __decorate([
        $mol_mem
...
(function ($) {
    class $aspirity_account_sign_in extends $mol_page {
        ...
        name_label() {
            return this.$.$mol_locale.text('$aspirity_account_sign_in_name_label');
        }
        name_bid() {
            return "";
        }
        ...
        pass_label() {
            return this.$.$mol_locale.text('$aspirity_account_sign_in_pass_label');
        }
        pass_bid() {
            return "";
        }
        ...
        submit_label() {
            return this.$.$mol_locale.text('$aspirity_account_sign_in_submit_label');
        }
        submit(val) {
            if (val !== undefined)
                return val;
