...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $aspirity_account_domain.prototype, "invoice", null);
    $.$aspirity_account_domain = $aspirity_account_domain;
})($ || ($ = {}));
//aspirity/account/domain/domain.ts
;
"use strict";
...
(function ($) {
    class $aspirity_account_transport extends $mol_object2 {
        static api_base() {
            return 'https://corssroc.herokuapp.com/https://helpmate.int.aspirity.com/';
        }
        static token(next) {
    ...
    __decorate([
        $mol_mem
    ], $aspirity_account_transport, "token", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_transport, "headers", null);
    __decorate([
        $mol_action
    ], $aspirity_account_transport, "request", null);
    __decorate([
        $mol_action
    ], $aspirity_account_transport, "load", null);
    __decorate([
        $mol_action
    ], $aspirity_account_transport, "save", null);
    $.$aspirity_account_transport = $aspirity_account_transport;
})($ || ($ = {}));
//aspirity/account/transport/transport.ts
;
"use strict";
var $;
(function ($) {
    ...
    $.$aspirity_account_invoice_response_dict = Arr(Rec({
        _id: Str,
        name: Str,
    }));
    ...
    $.$aspirity_account_invoice_response_company = Rec({
    ...
    class $aspirity_account_invoice_list extends $mol_store {
        domain() {
        ...
        list() {
            return Object.keys(this.data()).map(key => this.Item(key));
        }
        Item(id) {
    ...
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_list.prototype, "data", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_list.prototype, "filter", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_list.prototype, "list", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_invoice_list.prototype, "Item", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_invoice_list.prototype, "Invoice", null);
    $.$aspirity_account_invoice_list = $aspirity_account_invoice_list;
    class $aspirity_account_invoice extends $mol_store {
        list() {
    ...
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice.prototype, "load_full", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice.prototype, "company", null);
    $.$aspirity_account_invoice = $aspirity_account_invoice;
})($ || ($ = {}));
//aspirity/account/invoice/invoice.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    class $aspirity_account_invoice_page extends $mol_page {
        domain() {
            const obj = new this.$.$aspirity_account_domain();
            return obj;
        }
        invoice() {
            const obj = new this.$.$aspirity_account_invoice();
            return obj;
        }
        tools() {
            return [
        ...
        download_link() {
            return "https://www.google.com/search?q=PDF+not+working";
        }
        Download_icon() {
        ...
        Download() {
            ...
            obj.hint = () => this.$.$mol_locale.text('$aspirity_account_invoice_page_Download_hint');
        ...
        Close() {
            const obj = new this.$.$mol_link();
            obj.hint = () => this.$.$mol_locale.text('$aspirity_account_invoice_page_Close_hint');
            obj.arg = () => ({
                invoice: null
            });
            obj.sub = () => [
        ...
        Subject() {
            ...
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_invoice_page_Subject_title');
            obj.content = () => [
                this.subject()
            ];
            return obj;
        ...
        Number() {
            const obj = new this.$.$mol_labeler();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_invoice_page_Number_title');
            obj.content = () => [
                this.number()
            ];
            return obj;
        ...
        Status() {
            const obj = new this.$.$mol_labeler();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_invoice_page_Status_title');
            obj.content = () => [
                this.status()
            ];
            return obj;
        ...
        Contractor() {
            const obj = new this.$.$mol_labeler();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_invoice_page_Contractor_title');
            obj.content = () => [
                this.contractor()
            ];
            return obj;
        ...
        Name_full() {
            const obj = new this.$.$mol_labeler();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_invoice_page_Name_full_title');
            obj.content = () => [
                this.name_full()
            ];
            return obj;
        ...
        Name_short() {
            const obj = new this.$.$mol_labeler();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_invoice_page_Name_short_title');
            obj.content = () => [
                this.name_short()
            ];
            return obj;
        ...
        Address_actual() {
            const obj = new this.$.$mol_labeler();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_invoice_page_Address_actual_title');
            obj.content = () => [
                this.address_actual()
            ];
            return obj;
        ...
        Address_reg() {
            const obj = new this.$.$mol_labeler();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_invoice_page_Address_reg_title');
            obj.content = () => [
                this.address_reg()
            ];
            return obj;
        ...
        Logo() {
            ...
            obj.uri = () => this.logo();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_invoice_page_Logo_title');
            return obj;
        }
    }
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "domain", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "invoice", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Download_icon", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Download", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Close_icon", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Close", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Subject", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Number", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Status", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Contractor", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Info", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Name_full", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Name_short", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Company", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Address_actual", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Address_reg", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Address_row", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_invoice_page.prototype, "Logo", null);
    $.$aspirity_account_invoice_page = $aspirity_account_invoice_page;
})($ || ($ = {}));
//aspirity/account/invoice/page/-view.tree/page.view.tree.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        ...
        $mol_style_define($aspirity_account_invoice_page, {
            flex: {
                basis: rem(54),
                shrink: 0,
            },
...
//aspirity/account/invoice/page/page.view.css.ts
;
"use strict";
var $;
(function ($) {
...
//aspirity/account/invoice/page/page.view.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    class $aspirity_account_sign_in extends $mol_page {
        title() {
            return this.$.$mol_locale.text('$aspirity_account_sign_in_title');
        }
        body() {
            return [
                this.Sign_in()
        ...
        Name_field() {
            ...
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_sign_in_Name_field_name');
        ...
        Pass_field() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_sign_in_Pass_field_name');
        ...
        Submit() {
            ...
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_sign_in_Submit_title');
    ...
    __decorate([
        $mol_mem
    ], $aspirity_account_sign_in.prototype, "name", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_sign_in.prototype, "Name_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_sign_in.prototype, "Name_field", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_sign_in.prototype, "pass", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_sign_in.prototype, "Pass_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_sign_in.prototype, "Pass_field", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_sign_in.prototype, "submit", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_sign_in.prototype, "Submit", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_sign_in.prototype, "Sign_in", null);
    $.$aspirity_account_sign_in = $aspirity_account_sign_in;
})($ || ($ = {}));
//aspirity/account/sign/in/-view.tree/in.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
//aspirity/account/sign/in/in.view.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    class $aspirity_account_browse extends $mol_page {
        ...
        title() {
            return this.$.$mol_locale.text('$aspirity_account_browse_title');
        }
        tools() {
            return [
                this.New(),
        ...
        Link(id) {
            const obj = new this.$.$mol_link();
            obj.arg = () => ({
                invoice: this.invoice_link(id)
            });
            obj.sub = () => [
                this.Invoice_title(id)
            ];
            return obj;
        }
        Filter() {
        ...
        Invoice_title(id) {
            const obj = new this.$.$mol_dimmer();
            obj.haystack = () => this.invoice_title(id);
            obj.needle = () => this.query();
            return obj;
        }
        query(val) {
    ...
    __decorate([
        $mol_mem
    ], $aspirity_account_browse.prototype, "domain", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_browse.prototype, "Link", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse.prototype, "Filter", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse.prototype, "New_icon", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse.prototype, "New", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse.prototype, "Filter_toggle_icon", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse.prototype, "Filter_toggle", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse.prototype, "sign_out", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse.prototype, "Sign_out_icon", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse.prototype, "Sign_out", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse.prototype, "List", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_browse.prototype, "Invoice_title", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse.prototype, "query", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse.prototype, "Search", null);
    $.$aspirity_account_browse = $aspirity_account_browse;
    class $aspirity_account_browse_select extends $mol_select {
        ...
        Clear() {
            const obj = new this.$.$mol_button_minor();
            obj.hint = () => this.$.$mol_locale.text('$aspirity_account_browse_select_Clear_hint');
            obj.click = (event) => this.clear(event);
            obj.sub = () => [
                this.Clear_icon()
            ];
    ...
    __decorate([
        $mol_mem
    ], $aspirity_account_browse_select.prototype, "Clear", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse_select.prototype, "clear", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_browse_select.prototype, "Clear_icon", null);
    $.$aspirity_account_browse_select = $aspirity_account_browse_select;
})($ || ($ = {}));
//aspirity/account/browse/-view.tree/browse.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
//aspirity/account/browse/browse.view.css.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $aspirity_account_browse.prototype, "links", null);
        __decorate([
            $mol_mem_key
        ], $aspirity_account_browse.prototype, "invoice_link", null);
        __decorate([
            $mol_mem_key
        ], $aspirity_account_browse.prototype, "invoice_title", null);
        $$.$aspirity_account_browse = $aspirity_account_browse;
...
//aspirity/account/browse/browse.view.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    class $aspirity_account_new extends $mol_page {
        title() {
            return this.$.$mol_locale.text('$aspirity_account_new_title');
        }
        body() {
            return [
                this.List()
        ...
        Subject_control() {
            const obj = new this.$.$mol_string();
            obj.value = (val) => this.subject(val);
            return obj;
        }
        Subject() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Subject_name');
            obj.bid = () => this.subject_bid();
            obj.control = () => this.Subject_control();
            return obj;
        }
        number_bid() {
            return "";
        ...
        Number() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Number_name');
            obj.bid = () => this.number_bid();
            obj.control = () => this.Number_control();
            return obj;
        }
        status_bid() {
            return "";
        ...
        Status_control() {
            ...
            obj.value = (val) => this.status(val);
            obj.dictionary = () => this.status_dict();
            return obj;
        }
        Status() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Status_name');
            obj.bid = () => this.status_bid();
        ...
        Contractor_select() {
            const obj = new this.$.$mol_select();
            obj.value = (val) => this.contractor(val);
            obj.dictionary = () => this.contractor_dict();
            return obj;
        }
        Contractor_add_icon() {
            const obj = new this.$.$mol_icon_plus();
        ...
        Contractor() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Contractor_name');
            obj.bid = () => this.contractor_bid();
            obj.control = () => this.Contractor_control();
            return obj;
        }
        contact_bid() {
            return "";
        ...
        Contact_select() {
            const obj = new this.$.$mol_select();
            obj.value = (val) => this.contact(val);
            obj.dictionary = () => this.contact_dict();
            return obj;
        }
        Contact_add_icon() {
            const obj = new this.$.$mol_icon_plus();
        ...
        Contact() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Contact_name');
            obj.bid = () => this.contact_bid();
            obj.control = () => this.Contact_control();
            return obj;
        }
        terms_bid() {
            return "";
        ...
        Terms_control() {
            ...
            obj.minimal_height = () => 120;
            obj.value = (val) => this.terms(val);
            return obj;
        }
        Terms() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Terms_name');
            obj.bid = () => this.terms_bid();
            obj.control = () => this.Terms_control();
            return obj;
        }
        date_bid() {
            return "";
        ...
        Date_control() {
            const obj = new this.$.$aspirity_account_new_date();
            obj.value = (val) => this.date(val);
            return obj;
        }
        Date() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Date_name');
            obj.bid = () => this.date_bid();
        ...
        Invoice_control() {
            const obj = new this.$.$mol_select();
            obj.value = (val) => this.invoice(val);
            obj.dictionary = () => this.invoice_dict();
            return obj;
        }
        Invoice() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Invoice_name');
            obj.bid = () => this.invoice_bid();
            obj.control = () => this.Invoice_control();
            return obj;
        }
        company_bid() {
            return "";
        ...
        Company_control() {
            const obj = new this.$.$mol_select();
            obj.value = (val) => this.company(val);
            obj.dictionary = () => this.company_dict();
            return obj;
        }
        Company() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Company_name');
            obj.bid = () => this.company_bid();
            obj.control = () => this.Company_control();
            return obj;
        }
        currency_bid() {
            return "";
        ...
        Currency_control() {
            const obj = new this.$.$mol_select();
            obj.value = (val) => this.currency(val);
            obj.dictionary = () => this.currency_dict();
            return obj;
        }
        Currency() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Currency_name');
            obj.bid = () => this.currency_bid();
            obj.control = () => this.Currency_control();
            return obj;
        }
        rows() {
            return [];
        ...
        Table_content() {
            const obj = new this.$.$mol_view();
            obj.sub = () => this.table_content();
            return obj;
        }
        Table_field() {
            const obj = new this.$.$mol_form_field();
            obj.label = () => [];
            obj.Content = () => this.Table_content();
            return obj;
        }
        row_add(val) {
            if (val !== undefined)
        ...
        Add() {
            const obj = new this.$.$mol_button_major();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_new_Add_title');
            obj.click = (val) => this.row_add(val);
            return obj;
        }
        total() {
            return "0";
        ...
        Total() {
            const obj = new this.$.$mol_labeler();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_new_Total_title');
            obj.content = () => [
                this.total()
            ];
            return obj;
        ...
        People_control(id) {
            const obj = new this.$.$mol_select();
            obj.value = (val) => this.people(id, val);
            return obj;
        }
        People(id) {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_People_name');
            obj.bid = () => this.people_bid(id);
            obj.control = () => this.People_control(id);
            return obj;
        }
        position_bid(id) {
            return "";
        ...
        Position_control(id) {
            const obj = new this.$.$mol_select();
            obj.value = (val) => this.position(id, val);
            return obj;
        }
        Position(id) {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Position_name');
            obj.bid = () => this.position_bid(id);
        ...
        Rate_control(id) {
            const obj = new this.$.$mol_string();
            obj.value = (val) => this.rate(id, val);
            return obj;
        }
        Rate(id) {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Rate_name');
            obj.bid = () => this.rate_bid(id);
            obj.control = () => this.Rate_control(id);
            return obj;
        }
        time_bid(id) {
            return "";
        ...
        Time_control(id) {
            const obj = new this.$.$mol_string();
            obj.value = (val) => this.time(id, val);
            return obj;
        }
        Time(id) {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Time_name');
            obj.bid = () => this.time_bid(id);
            obj.control = () => this.Time_control(id);
            return obj;
        }
        price(id) {
            return "0";
        ...
        Price(id) {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_new_Price_name');
            obj.Content = () => this.Price_content(id);
            return obj;
        }
    }
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "Row", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "subject", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Subject_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Subject", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "number", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Number_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Number", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "status", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Status_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Status", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "contractor", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Contractor_select", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Contractor_add_icon", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Contractor_add", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Contractor_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Contractor", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "contact", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Contact_select", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Contact_add_icon", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Contact_add", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Contact_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Contact", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "terms", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Terms_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Terms", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "date", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Date_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Date", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "invoice", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Invoice_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Invoice", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "company", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Company_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Company", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "currency", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Currency_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Currency", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Table", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Table_content", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Table_field", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "row_add", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Add", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "Total", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "New", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_new.prototype, "List", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "people", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "People_control", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "People", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "position", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "Position_control", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "Position", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "rate", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "Rate_control", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "Rate", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "time", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "Time_control", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "Time", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "Price_content", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account_new.prototype, "Price", null);
    $.$aspirity_account_new = $aspirity_account_new;
    class $aspirity_account_new_date extends $mol_date {
        hint() {
            return "YYYY-MM-DD";
        }
    }
    $.$aspirity_account_new_date = $aspirity_account_new_date;
})($ || ($ = {}));
//aspirity/account/new/-view.tree/new.view.tree.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        const { rem } = $mol_style_unit;
        $mol_style_define($aspirity_account_new, {
            flex: {
                basis: rem(52),
                shrink: 0,
            },
...
//aspirity/account/new/new.view.css.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $aspirity_account_new.prototype, "status_dict", null);
        __decorate([
            $mol_mem
        ], $aspirity_account_new.prototype, "contractor_dict", null);
        __decorate([
            $mol_mem
        ], $aspirity_account_new.prototype, "contact_dict", null);
        __decorate([
            $mol_mem
        ], $aspirity_account_new.prototype, "invoice_dict", null);
        __decorate([
            $mol_mem
        ], $aspirity_account_new.prototype, "company_dict", null);
        __decorate([
            $mol_mem
        ], $aspirity_account_new.prototype, "currency_dict", null);
        __decorate([
            $mol_mem
        ], $aspirity_account_new.prototype, "row_list", null);
        $$.$aspirity_account_new = $aspirity_account_new;
        class $aspirity_account_new_date extends $.$aspirity_account_new_date {
            ...
            value(val) {
                const moment = this.value_moment();
                if (val === undefined)
                    return moment?.toString(this.format()) ?? '';
                const moment2 = $mol_try(() => val && new $mol_time_moment(val)) || null;
                if (moment2 instanceof Error)
                    return val;
                this.value_moment(moment2);
        ...
        __decorate([
            $mol_mem
        ], $aspirity_account_new_date.prototype, "value", null);
        $$.$aspirity_account_new_date = $aspirity_account_new_date;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//aspirity/account/new/new.view.ts
;
"use strict";
var $;
(function ($) {
    class $aspirity_account_contact extends $mol_page {
        title() {
            return this.$.$mol_locale.text('$aspirity_account_contact_title');
        }
        body() {
            return [
                this.Form()
        ...
        Name() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_contact_Name_name');
            obj.bid = () => this.name_bid();
            obj.control = () => this.Name_control();
            return obj;
        }
        ...
        Phone_control() {
            const obj = new this.$.$mol_string();
            obj.value = (val) => this.phone(val);
            return obj;
        }
        Phone() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_contact_Phone_name');
        ...
        Email() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_contact_Email_name');
        ...
        Comment_control() {
            const obj = new this.$.$mol_textarea();
            obj.value = (val) => this.comment(val);
            return obj;
        }
        Comment() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_contact_Comment_name');
            obj.bid = () => this.comment_bid();
            obj.control = () => this.Comment_control();
            return obj;
        }
        submit(val) {
            if (val !== undefined)
        ...
        Submit() {
            const obj = new this.$.$mol_button_major();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_contact_Submit_title');
            obj.click = (val) => this.submit(val);
            obj.enabled = () => this.enabled();
            return obj;
        }
    ...
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "name", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "Name_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "Name", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "phone", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "Phone_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "Phone", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "email", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "Email_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "Email", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "comment", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "Comment_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "Comment", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "submit", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "enabled", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "Submit", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact.prototype, "Form", null);
    $.$aspirity_account_contact = $aspirity_account_contact;
})($ || ($ = {}));
//aspirity/account/contact/-view.tree/contact.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
//aspirity/account/contact/contact.view.ts
;
"use strict";
var $;
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $aspirity_account_contact_select.prototype, "value", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact_select.prototype, "Select", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact_select.prototype, "Add_icon", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contact_select.prototype, "Add", null);
    $.$aspirity_account_contact_select = $aspirity_account_contact_select;
})($ || ($ = {}));
//aspirity/account/contact/select/-view.tree/select.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
//aspirity/account/contact/select/select.view.ts
;
"use strict";
var $;
(function ($) {
    class $aspirity_account_contractor extends $mol_page {
        title() {
            return this.$.$mol_locale.text('$aspirity_account_contractor_title');
        }
        body() {
            return [
                this.Form()
        ...
        Company() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_contractor_Company_name');
            obj.bid = () => this.company_bid();
            obj.control = () => this.Company_control();
            return obj;
        }
        ...
        Phone() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_contractor_Phone_name');
            obj.bid = () => this.phone_bid();
            obj.control = () => this.Phone_control();
            return obj;
        }
        ...
        Email() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_contractor_Email_name');
            obj.bid = () => this.email_bid();
            obj.control = () => this.Email_control();
            return obj;
        }
        ...
        Comment() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_contractor_Comment_name');
            obj.bid = () => this.comment_bid();
            obj.control = () => this.Comment_control();
            return obj;
        }
        ...
        Contact_control() {
            const obj = new this.$.$aspirity_account_contact_select();
            obj.value = (val) => this.contact(val);
            return obj;
        }
        Contact() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => this.$.$mol_locale.text('$aspirity_account_contractor_Contact_name');
            obj.bid = () => this.contact_bid();
            obj.control = () => this.Contact_control();
            return obj;
        }
        ...
        Submit() {
            const obj = new this.$.$mol_button_major();
            obj.title = () => this.$.$mol_locale.text('$aspirity_account_contractor_Submit_title');
            obj.click = (val) => this.submit(val);
            return obj;
        }
        Form() {
    ...
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "company", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "Company_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "Company", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "phone", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "Phone_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "Phone", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "email", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "Email_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "Email", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "comment", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "Comment_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "Comment", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "contact", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "Contact_control", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "Contact", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "submit", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "Submit", null);
    __decorate([
        $mol_mem
    ], $aspirity_account_contractor.prototype, "Form", null);
    $.$aspirity_account_contractor = $aspirity_account_contractor;
})($ || ($ = {}));
//aspirity/account/contractor/-view.tree/contractor.view.tree.ts
;
"use strict";
var $;
(function ($) {
    class $aspirity_account extends $mol_book2 {
        ...
        Invoice(id) {
            const obj = new this.$.$aspirity_account_invoice_page();
        ...
        Sign_in() {
            const obj = new this.$.$aspirity_account_sign_in();
            return obj;
        }
        filter_enabled() {
            return false;
        ...
        Browse() {
            const obj = new this.$.$aspirity_account_browse();
            obj.domain = () => this.domain();
            obj.filter = () => this.filter_enabled();
            return obj;
        }
        New() {
            const obj = new this.$.$aspirity_account_new();
            return obj;
        }
        Contractor() {
            const obj = new this.$.$aspirity_account_contractor();
            return obj;
        }
        Contact() {
            const obj = new this.$.$aspirity_account_contact();
            return obj;
        }
        invoice(id) {
            const obj = new this.$.$aspirity_account_invoice();
    ...
    __decorate([
        $mol_mem
    ], $aspirity_account.prototype, "domain", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account.prototype, "Invoice", null);
    __decorate([
        $mol_mem
    ], $aspirity_account.prototype, "Placeholder", null);
    __decorate([
        $mol_mem
    ], $aspirity_account.prototype, "Sign_in", null);
    __decorate([
        $mol_mem
    ], $aspirity_account.prototype, "Browse", null);
    __decorate([
        $mol_mem
    ], $aspirity_account.prototype, "New", null);
    __decorate([
        $mol_mem
    ], $aspirity_account.prototype, "Contractor", null);
    __decorate([
        $mol_mem
    ], $aspirity_account.prototype, "Contact", null);
    __decorate([
        $mol_mem_key
    ], $aspirity_account.prototype, "invoice", null);
    $.$aspirity_account = $aspirity_account;
})($ || ($ = {}));
//aspirity/account/-view.tree/account.view.tree.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $aspirity_account.prototype, "pages", null);
        $$.$aspirity_account = $aspirity_account;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//aspirity/account/account.view.ts
;
"use strict";
var $;
(function ($) {
