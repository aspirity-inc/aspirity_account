...
declare namespace $ {
    const Res_invoice_company: ((val: unknown) => Readonly<{
...
declare namespace $.$$ {
    class $aspirity_account extends $.$aspirity_account {
        ...
        pages(): $aspirity_account_sign_in[] | ($aspirity_account_invoice_page | $aspirity_account_browse)[];
    }
}
